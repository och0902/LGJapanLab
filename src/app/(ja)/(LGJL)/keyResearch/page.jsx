...
const JLKeyResearch = () => {
	...
	return (
		<Box className='pageContainer'>
         <PageHero image='/images/lgjl/keyResearch/KeyResearch.jpg' aspectRatio='1920/400' title='重点研究課題' />
					...
					<Box sx={{ width: '100%' }}>
						<Box sx={{ width: '80%', m: 'auto', mt: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
							<Box sx={{ display: 'flex', gap: '30px', [theme.breakpoints.down('lg')] : { gap : '10px' } }}>
								...
								<Box sx={{ width: '1px', borderRight: '1px solid var(--color-LGgray-light)' }}></Box>
								<Box sx={{ fontSize: '2.5rem', fontWeight: 'var(--weight-bold)', color: 'green', display: 'flex', alignItems: 'center',
